...
- `modules.brokers.kis._internal.headers` — `build_websocket_subscribe_message`
- `modules.brokers.kis.config` — `websocket_url`
- `modules.brokers.kis.endpoints.registry` — `lookup`
- `modules.brokers.kis.exceptions` — `KisRealtimeError`
- `modules.brokers.kis.models.orderbook`, `modules.brokers.kis.models.tick`
- `modules.brokers.kis.parsers.realtime` — `parse_realtime_frame`
