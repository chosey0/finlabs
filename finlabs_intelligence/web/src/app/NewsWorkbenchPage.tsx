...
// News-collection workbench. Top to bottom: a command bar (search), the
// selection bridge (signature), the two-pane workbench (chart | news always
// co-visible), and a footer that carries dataset export and the status line.
// This page owns the cross-feature shared state and orchestrates workflow resets.
export function NewsWorkbenchPage() {
