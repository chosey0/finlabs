...
집계는 `scripts/collect_metrics.py`로 자동화할 수 있습니다.

```bash
python research/notebooks/01_shape_quantization/scripts/collect_metrics.py \
    --runs-dir research/notebooks/01_shape_quantization/runs \
    --out research/notebooks/01_shape_quantization/summaries/summary.csv
```
